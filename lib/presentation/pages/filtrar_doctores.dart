...
import 'package:meetical_project/presentation/pages/info_doctor.dart';
...
class _FiltrarDoctoresScreenState extends State<FiltrarDoctoresScreen> {
  ...
  Future<void> obtenerDoctores() async {
    final response = await http.get(
      Uri.parse('http://localhost:3000/api/doctors'),
    );
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  subtitle: Text(
                    '${doctor['specialty'] ?? 'Sin especialidad'} - ${doctor['location'] ?? 'Sin ciudad'}',
                  ),
                  onTap: () {
                    Navigator.push(
                      context,
